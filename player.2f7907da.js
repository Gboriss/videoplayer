...
var skippers = document.querySelectorAll('.player-btn');
var time = document.querySelector('.time');
var load = document.querySelector('.load');
var ranges = document.querySelectorAll('.player-slider');
var imgCorgi = document.getElementById('imgCorgi');
...
function videoTime() {
  ...
  var f = duration - video.currentTime;
  var minutes = Math.floor(f / 60 % 60);
  var seconds = Math.floor(f % 60);
  var test = (minutes > 0 ? minutes : '0') + ' : ' + (seconds > 0 ? seconds : '0');
  load.innerText = test;
}
...
function progressUpdate() {
  progressFilled.style.flexBasis = video.currentTime / video.duration * 100 + '%'; // progressFilled.style.flexBasis = `${percent}%`
}
...
video.addEventListener('loadedmetadata', loadTime); // secondsUpdated
// loadedmetadata
...
imgCorgi.addEventListener('click', function () {
...
},{}]},{},["C:/Users/Xiaomi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","player.js"], null)
